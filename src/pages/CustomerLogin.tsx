  ...
  const onSubmit = async (values: LoginFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to PlyInventory catalog",
      });
    } catch (error: any) {
      toast({
        title: "Login failed",
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 to-wood-light">
      <div className="w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Customer Access Portal</p>
        </div>
        
        <Card className="border-wood shadow-lg animate-fade-in">
          <CardHeader>
            <CardTitle className="text-2xl text-navy">Customer Login</CardTitle>
            <CardDescription>Access the plywood catalog and your orders</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
          ...
          <CardFooter className="flex justify-between">
            ...
            <Link to="/customer-register">
              <Button variant="link" className="p-0">Register as Customer</Button>
            </Link>
          </CardFooter>
